...
const Japanese = () => {
  ...
  const getRecipeData = () => {
    fetch(
      'https://api.spoonacular.com/recipes/complexSearch?cuisine=Japanese&number=22&apiKey=e042e0c751074d1c99ac2a2b6407f951',
      {
        method: 'GET',
        headers: {
  ...
  return (
    <View style={styles.root}>
      <Text style={styles.mainHeader}>Japanese Recipes</Text>
      <FlatList

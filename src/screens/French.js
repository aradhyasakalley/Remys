...
const French = () => {
  ...
  const getRecipeData = () => {
    fetch(
      'https://api.spoonacular.com/recipes/complexSearch?cuisine=French&number=22&apiKey=e042e0c751074d1c99ac2a2b6407f951',
      {
        method: 'GET',
        headers: {
  ...
  return (
    <View style={styles.root}>
      <Text style={styles.mainHeader}>French Recipes</Text>
      <FlatList

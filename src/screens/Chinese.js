...
const Chinese = () => {
  ...
  const getRecipeData = () => {
    fetch(
      'https://api.spoonacular.com/recipes/complexSearch?cuisine=Chinese&number=22&apiKey=e042e0c751074d1c99ac2a2b6407f951',
      {
        method: 'GET',
        headers: {
  ...
  return (
    <View style={styles.root}>
      <Text style={styles.mainHeader}>Chinese Recipes</Text>
      <FlatList
